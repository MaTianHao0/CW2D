...
{
    public class MarkSection : GH_Component
    {
        public MarkSection() : base("剖面图标注", "剖面图标注", "剖面图标注", Title.CW2D(), Title.Section())
        {
        }
        ...
        protected override Bitmap Icon
        {
            get
            {
                try
                {
                    ...
                    var resourceName = "CW2D.Resources.Section Annotation.png";
        ...
        public override Guid ComponentGuid => new Guid("{854CB65E-47FD-4BB5-B1E5-11AB2CCE0DA0}");
    }
}