...
namespace CW2D.MakeElevation
{
    ...
    public class DrawElevation_Right : GH_Component
    {
        public override GH_Exposure Exposure
        {
            get { return GH_Exposure.primary; }
        }
        public DrawElevation_Right()
          : base("立面图-右视图", "Nickname",
              "Description",
            ...
            if (num > 0)
            {
                ...
                foreach (HiddenLineDrawingSegment segment in hiddenLineDrawing.Segments)
                {
                    ...
                    foreach (var item in attribute)
                        curve.SetUserString(item.Key, item.Value); //属性赋值或属性获取  线是有属性信息的 
        ...
        {
            get { return new Guid("C9453A08-F7FC-476A-BA58-7CD02022525F"); }
        }
    }
}