...
{
    public class MarkElevation : GH_Component
    {
        public MarkElevation() : base("立面图标注", "立面图标注", "立面图标注", Title.CW2D(), Title.Elevation())
        {
        }
        ...
        protected override Bitmap Icon
        {
            get
            {
                try
                {
                    ...
                    var resourceName = "CW2D.Resources.Elevation Annotation.png";
        ...
        public override Guid ComponentGuid => new Guid("{EE7AC1BD-FE24-452D-8AD6-77D3DACDB4E1}");
    }
}