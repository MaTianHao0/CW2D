...
{
    public class MarkDetail : GH_Component
    {
        public MarkDetail() : base("大样图标注", "大样图标注", "大样图标注", Title.CW2D(), Title.Detail())
        {
        }
        ...
        protected override Bitmap Icon
        {
            get
            {
                try
                {
                    ...
                    var resourceName = "CW2D.Resources.Detail Annotation.png";
        ...
        public override Guid ComponentGuid => new Guid("{B0C9EEBE-F53F-4418-8EE1-A8E8099038DC}");
    }
}