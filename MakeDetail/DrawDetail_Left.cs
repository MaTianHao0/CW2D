...
{
    public class DrawDetail_Left : GH_Component
    {
        public DrawDetail_Left()
          : base("大样图(左视)", "大样图(左视)",
              "大样图(左视)",
        ...
        protected override Bitmap Icon
        {
            get
            {
                try
                {
                    ...
                    var resourceName = "CW2D.Resources.detail-left.png";
        ...
        {
            get { return new Guid("50931285-84B6-4813-9356-9957361C4959"); }
        }
    }
}