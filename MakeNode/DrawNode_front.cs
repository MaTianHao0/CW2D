...
{
    public class DrawNode_front : GH_Component
    {
        public DrawNode_front() : base("节点图(正视)", "节点图", "生成节点图", Title.CW2D(), Title.Node())
        {
        }
        ...
        {
            pManager.AddCurveParameter("图样", "G", "图样", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            foreach (var geo in geos)
            {
                ...
                if (goo.Boundingbox.Max.Y < rect.Center.Y) continue;
        ...
        protected override Bitmap Icon
        {
            get
            {
                try
                {
                    ...
                    var resourceName = "CW2D.Resources.Node-front.png";
        ...
        {
            get { return new Guid("E47782E3-E2B5-4422-B3AB-7E5F5DB3541C"); }
        }
    }
